class AddManualIdxRolesPosition < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  TABLE_NAME = :roles
  INDEX_COLUMNS = [:position].freeze
  INDEX_NAME = "manual_idx_roles_position"
