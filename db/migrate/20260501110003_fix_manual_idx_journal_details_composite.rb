class FixManualIdxJournalDetailsComposite < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  TABLE_NAME = :journal_details
  INDEX_COLUMNS = [:journal_id, :prop_key].freeze
  INDEX_NAME = "manual_prefix_idx_journal_details_on_journal_id_prop_key"
