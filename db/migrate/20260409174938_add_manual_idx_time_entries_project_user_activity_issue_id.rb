class AddManualIdxTimeEntriesProjectUserActivityIssueId < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  TABLE_NAME = :time_entries
  INDEX_COLUMNS = [:project_id, :user_id, :activity_id, :issue_id, :id].freeze
