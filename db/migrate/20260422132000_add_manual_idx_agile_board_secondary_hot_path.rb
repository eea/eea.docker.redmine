class AddManualIdxAgileBoardSecondaryHotPath < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  INDEX_DEFINITIONS = [
    {
      table: :issues,
      columns: [:status_id, :tracker_id, :project_id, :assigned_to_id, :id],
      name: "manual_idx_issues_on_status_tracker_project_assignee_id"
    },
    {
      table: :agile_data,
      columns: [:issue_id, :position],
      name: "manual_idx_agile_data_on_issue_id_position"
    }
  ].freeze
