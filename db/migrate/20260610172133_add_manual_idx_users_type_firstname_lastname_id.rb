class AddManualIdxUsersTypeFirstnameLastnameId < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  TABLE_NAME = :users
  INDEX_COLUMNS = [:type, :firstname, :lastname, :id].freeze
  INDEX_NAME = "manual_idx_users_type_firstname_lastname_id"
