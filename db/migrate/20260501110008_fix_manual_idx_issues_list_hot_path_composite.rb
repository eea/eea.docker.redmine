class FixManualIdxIssuesListHotPathComposite < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  disable_ddl_transaction!

  TABLE_NAME = :issues
  INDEX_COLUMNS = [:project_id, :id].freeze
  INDEX_NAME = "manual_idx_issues_list_hot_path"
  ...
  def up
    ...
    if index_name_exists?(TABLE_NAME, INDEX_NAME) ||
        composite_index_exists?(TABLE_NAME, INDEX_COLUMNS)
