class AddManualIdxAgileBoardHotPath < ActiveRecord::Migration["#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}".to_f]
  ...
  INDEX_DEFINITIONS = [
    {
      ...
      name: "manual_idx_enabled_modules_on_project_id_name"
    },
    {
      table: :issues,
      columns: [:tracker_id, :project_id],
      name: "manual_idx_issues_on_tracker_id_project_id"
    },
    {
      table: :projects,
      columns: [:status, :id],
      name: "manual_idx_projects_on_status_id"
    }
  ].freeze
